...
//        $this->middleware('auth');
    ...
    public function index()
    {
        ...
        $site_data = Common::getSiteData();
				...
				$topCelebrities = Common::getAthletesDataPerOrder('price', 'desc', 0, 8);
//        dd($topCelebrities);
        return view('frontend.home')->with(['site_data'=>$site_data, 'contractAddress'=>$contractAddress, 'provider'=>$provider, 'top_athletes'=>$topCelebrities]);
    }
}
